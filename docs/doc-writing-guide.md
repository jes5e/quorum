...
- `missing` — no gauge file exists for this session, and the gauge directory was traversable enough to establish that. Usually means no producer is configured in this environment.
