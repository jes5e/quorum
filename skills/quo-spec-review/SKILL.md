...
3. **Review against the criteria below**, citing the document and section in every finding.
4. **Output the findings** in the shape below, then stop. When this runs standalone, the user reads the list and decides; there is no gate.
