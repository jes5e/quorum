...
- **Multi-Epic run mode:** <Mode 1 (Stop after each Epic) | Mode 2 (Work through all Epics) | not captured (single Epic in scope) | not captured (all Epics already done) | not captured (no workable Epic) | not captured | captured late>
