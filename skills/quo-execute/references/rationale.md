...
- Warm `SendMessage` dispatch needs an experimental teams substrate this skill set does not use; cold dispatch re-loads each role file per dispatch, and prompt caching absorbs most of that cost.
