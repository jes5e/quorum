#!/usr/bin/env python3
"""Fast-path detection for /quo-setup.
...
# quo-setup slow path emits. If a user hand-edits CLAUDE.md to drop the bold
...
def main():
    parser = argparse.ArgumentParser(description="Detect /quo-setup fast-path eligibility")
