...
- Orchestrate in-flight `/bees-engineer-review` and `/bees-doc-writer-review` invocations against the Task's diff, with a time-budget short-circuit when reviews run hot.
